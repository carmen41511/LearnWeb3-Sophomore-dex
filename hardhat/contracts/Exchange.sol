...
contract Exchange is ERC20{
    ...
    // responsible for minting and issuing LP Tokens
    ...
    // calculates the amount of output tokens received based on xy = (x + dx)(y - dy)
    function getOutputAmountFromSwap(
        uint256 inputAmount, 
        uint256 inputReserve,
        uint256 outputReserve
    ) public pure returns (uint256) {
        require(inputReserve > 0 && outputReserve > 0, "Reserves mumst be greater than 0");
